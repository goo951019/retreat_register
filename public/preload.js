...
contextBridge.exposeInMainWorld('api', {
    ...
    requestVisibleChurch: (args) => ipcRenderer.send('request-visible-church', args),
    getVisibleChurch: (callback) => ipcRenderer.on('get-visible-church', (event, data) => {callback(data)}),
    // add / delete Church
    ...
    requestVisibleSleeping_Area: (args) => ipcRenderer.send('request-visible-sleeping_area', args),
    getVisibleSleeping_Area: (callback) => ipcRenderer.on('get-visible-sleeping_area', (event, data) => {callback(data)}),
